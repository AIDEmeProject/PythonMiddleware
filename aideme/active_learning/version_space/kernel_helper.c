...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "kernel_helper",
        "sources": [
            "aideme/active_learning/version_space/kernel_helper.pyx"
        ]
    },
    "module_name": "kernel_helper"
}
END: Cython Metadata */
...
#define __PYX_HAVE__kernel_helper
#define __PYX_HAVE_API__kernel_helper
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'kernel_helper' */
...
static void __pyx_f_13kernel_helper_partial_cholesky(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "kernel_helper"
extern int __pyx_module_is_main_kernel_helper;
int __pyx_module_is_main_kernel_helper = 0;

/* Implementation of 'kernel_helper' */
...
static PyObject *__pyx_pf_13kernel_helper_partial_cholesky(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_L, __Pyx_memviewslice __pyx_v_K); /* proto */
...
static PyObject *__pyx_pw_13kernel_helper_1partial_cholesky(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_13kernel_helper_partial_cholesky(__Pyx_memviewslice __pyx_v_L, __Pyx_memviewslice __pyx_v_K, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  int __pyx_v_dim;
  double __pyx_v_sum;
  int __pyx_v_i;
  ...
  __Pyx_RefNannySetupContext("partial_cholesky", 0);

  /* "kernel_helper.pyx":24
 * @cdivision(True)
 * cpdef void partial_cholesky(double[:, ::1] L, double[:, ::1] K):
 *     cdef int n = K.shape[0], dim = K.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double sum
 * 
 */
  __pyx_v_n = (__pyx_v_K.shape[0]);
  __pyx_v_dim = (__pyx_v_K.shape[1]);

  /* "kernel_helper.pyx":27
 *     cdef double sum
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         sum = 0
 ...
 */
        ...
        *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_14 * __pyx_v_K.strides[0]) )) + __pyx_t_15)) )) -= ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_10 * __pyx_v_K.strides[0]) )) + __pyx_t_11)) ))) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_L.data + __pyx_t_12 * __pyx_v_L.strides[0]) )) + __pyx_t_13)) ))));
      }

      /* "kernel_helper.pyx":34
 *                 K[i, j] -= K[i, k] * L[j, k]
 * 
 *             K[i, j] /= L[j, j]             # <<<<<<<<<<<<<<
 *             sum += K[i, j] * K[i, j]
 ...
 */
      ...
      *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_18 * __pyx_v_K.strides[0]) )) + __pyx_t_19)) )) /= (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_L.data + __pyx_t_16 * __pyx_v_L.strides[0]) )) + __pyx_t_17)) )));

      /* "kernel_helper.pyx":35
 * 
 *             K[i, j] /= L[j, j]
 *             sum += K[i, j] * K[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_sum = (__pyx_v_sum + ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_20 * __pyx_v_K.strides[0]) )) + __pyx_t_21)) ))) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_22 * __pyx_v_K.strides[0]) )) + __pyx_t_23)) )))));
    }

    /* "kernel_helper.pyx":37
 *             sum += K[i, j] * K[i, j]
 * 
 *         K[i, dim - 1] = sqrt(1 - sum)             # <<<<<<<<<<<<<<
 */
    __pyx_t_24 = __pyx_v_i;
    __pyx_t_25 = (__pyx_v_dim - 1);
    *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_24 * __pyx_v_K.strides[0]) )) + __pyx_t_25)) )) = sqrt((1.0 - __pyx_v_sum));
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_13kernel_helper_1partial_cholesky(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13kernel_helper_1partial_cholesky(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_L = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_K = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("partial_cholesky (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_K)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("partial_cholesky", 1, 2, 2, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "partial_cholesky") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    ...
    __pyx_v_L = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_L.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_K = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_K.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("partial_cholesky", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("kernel_helper.partial_cholesky", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13kernel_helper_partial_cholesky(__pyx_self, __pyx_v_L, __pyx_v_K);
...
static PyObject *__pyx_pf_13kernel_helper_partial_cholesky(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_L, __Pyx_memviewslice __pyx_v_K) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("partial_cholesky", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_L.memview)) { __Pyx_RaiseUnboundLocalError("L"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_K.memview)) { __Pyx_RaiseUnboundLocalError("K"); __PYX_ERR(0, 23, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_13kernel_helper_partial_cholesky(__pyx_v_L, __pyx_v_K, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "kernel_helper.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "kernel_helper._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"partial_cholesky", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13kernel_helper_1partial_cholesky, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_kernel_helper(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_kernel_helper},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initkernel_helper(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initkernel_helper(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_kernel_helper(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_kernel_helper(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_kernel_helper(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'kernel_helper' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_kernel_helper(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("kernel_helper", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_kernel_helper) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kernel_helper")) {
      if (unlikely(PyDict_SetItemString(modules, "kernel_helper", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kernel_helper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kernel_helper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
